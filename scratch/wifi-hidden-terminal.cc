...
void experiment (bool enableCtsRts)
{
  ...
  positionAlloc->Add (Vector (3005.0, 0.0, 0.0));
  ...
  lossModel->SetLambda (300000000.0/2437e6);
  ...
  wifiPhy.Set ("TxPowerStart", DoubleValue (10)); //potencia de transmissao de 100mW
  ...
  //Primeira aplicacao envia do no 1 para o no 2, segunda aplicacao envia do no 4 para o no 3
